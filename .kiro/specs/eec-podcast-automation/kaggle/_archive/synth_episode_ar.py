...
# ==========================================================================
# CELL 3 (zip + download) — paste into a NEW cell and run after synth finishes.
# Packages the whole WORK dir (WAVs + manifest.json + timeline.json +
# qa_flagged.json) into ONE zip: ep01_ar.zip. Download it from the Output panel
# (right side) and drop it in Drive raw-audio. The server merges both passes.
# ==========================================================================
# import shutil, os
